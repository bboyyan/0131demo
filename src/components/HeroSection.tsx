        ...
        <section className="relative h-[100vh] md:h-[900px] flex flex-col justify-center md:justify-start md:pt-40 px-6 md:px-16 overflow-hidden">
            ...
            <div className="relative z-10 max-w-4xl mt-0 md:mt-20">
                ...
                <motion.h1
                    ...
                    className="text-5xl md:text-8xl font-cormorant font-light text-white leading-[1.1] mb-8 mix-blend-overlay opacity-90"
                >
                    Awaken Your <br />
                    <span className="font-playfair italic text-rose-100/90 font-normal">Inner Beauty</span>
                </motion.h1>
                ...
                <motion.p
                    ...
                    className="text-neutral-200 text-lg md:text-xl max-w-lg mb-12 font-light tracking-wide leading-relaxed font-cormorant"
                >
                ...
                >
                    <div className="flex-1 px-8 py-5 group cursor-pointer border-r border-neutral-200/50">
                        ...
                        <div className="text-neutral-800 font-playfair text-lg italic group-hover:text-rose-500 transition-colors">Full Body & Bust Care</div>
                    </div>
                    <div className="flex-1 px-8 py-5 group cursor-pointer border-r border-neutral-200/50">
                        <div className="text-[10px] text-neutral-500 uppercase tracking-widest mb-1 font-bold">Location</div>
                        <div className="text-neutral-800 font-playfair text-lg italic group-hover:text-rose-500 transition-colors">Taipei Flagship</div>
                    </div>
                    <div className="flex-1 px-8 py-5 group cursor-pointer">
                        ...
                        <div className="text-neutral-800 font-playfair text-lg italic group-hover:text-rose-500 transition-colors">Select a Date</div>
                    </div>
                    <button className="bg-neutral-900 text-white w-16 h-16 rounded-full flex items-center justify-center hover:bg-rose-500 transition-all duration-300 shadow-lg transform hover:scale-105 cursor-pointer">
                        <ArrowRight size={20} />
                    </button>
                </motion.div>
            </div>
